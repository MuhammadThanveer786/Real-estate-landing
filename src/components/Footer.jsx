    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id="Footer">
      <div className='Container mx-auto flex flex-col md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          ...
          We help you find the perfect place to call home. From residential homes to commercial spaces, our platform offers trusted listings, expert advice, and a smooth property search experience tailored to your needs.</p>
        </div>
        ...
        <div className='w-full md:w-1/3'>
          ...
          <div className='flex gap-2'>
            ...
            <button className='bg-blue-500 rounded py-2 px-4 text-white'>Subscribe</button>
          </div>

        </div>
      </div>
      <div className='mt-10 border-t border-gray-700 pt-6 text-center text-gray-500 text-sm mb-5'>
       Copyright 2025 © Muhammad Thanveer. All rights reserved.
      </div>
    </div>
  )
}
