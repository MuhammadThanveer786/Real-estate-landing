...
const Projects = () => {
  ...
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id="Projects">
      <h1 className='font-bold text-2xl sm:text-4xl mb-2 text-center'>Projects<span className='font-light underline underline-offset-4 under decoration-1'> Completed</span></h1>
      <p className='text-gray-600 text-center max-w-80 mb-8 mx-auto'>Crafting Spaces, Building Legacies-Explore Our Protfolio</p>
